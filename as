...
<head>
  <meta charset="UTF-8">
  <title>Áudio</title>
  <link rel="stylesheet" href="css/sNfCqPqBn3GT.css">
  <link rel="stylesheet" href="css/orKHXR8rRqBT.css">
  <style>
...
<body>
  <div class="audio-container" id="audioContainer">
    ...
    <audio class="plyr" src="https://audio.jukehost.co.uk/G8POSvm3XJNNdQFNJZrvkfLnhT6fXfkG"></audio>
    <!-- Cole o link da Sua imagem Abaixo-->
    <img src="https://i.postimg.cc/L4G0ZxFR/Design-sem-nome.png" alt="Imagem">
    <div class="microphone-icon">
      <i class="fas fa-microphone"></i>
    </div>
  </div>
  
  <script src="js/Vb8MC946IipL.js"></script>
  <script>
